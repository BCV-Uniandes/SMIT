...
class Generator(nn.Module):
  ...
  def __init__(self, image_size = 128, conv_dim=64, c_dim=5, repeat_num=6, SAGAN=False, Attention=False, AdaIn=None, debug=False):
...
class AdaInGEN(nn.Module):
  def __init__(self, Generator):
    ...
    self.adain_net = MLP(style_dim, self.get_num_adain_params(Generator), mlp_dim, 3, norm='none', activ=activ)
