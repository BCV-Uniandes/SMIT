...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        #PatchGAN
        self.conv1 = nn.Conv2d(1024, 1, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv2 = nn.Conv2d(1024, num_classes, kernel_size=2, bias=False)
    ...
    def forward(self, x, lstm=False):
        ...
        out_real = self.conv1(out)
        out_aux = self.conv2(out)
        # ipdb.set_trace()        
        if lstm:
